...
data class IncomeCategory(override val id: CategoryID, override val name: SimpleName) :
    Category(id, name)

data class ExpenseCategory(override val id: CategoryID, override val name: SimpleName) :
    Category(id, name)